...
x = data_processing(file_mouth_printing(user_input_year))[0]
male = data_processing(file_mouth_printing(user_input_year))[1]
female = data_processing(file_mouth_printing(user_input_year))[2]
